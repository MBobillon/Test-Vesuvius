...
// Point class with some geometrical functions
class Point
{
...
// static function to extract points on the reflector band
static 
...
// Compute volume of a tetrahedon generated by a triangle "ABC" and the origin point O (0.,0. ,0.)
// this volume equal to :
// abs((OA*OB).OC)) / 6
// where OA*OB is the cross product of this vecotr
// and (OA*OB).OC) is the scalar product 
